...
typedef enum
{
    ...
    // CWSL_REGISTRATION_SUCCESSFUL    = 216,      ///< 播报：学习成功
    ...
    CWSL_REG_WAKE_UP                 = 10195,      // STUDY-WAKE
    CWSL_DEL_WAKE_UP                 = 10200,      // DELETE-WAKE
    CWSL_REG_11                       = 10196,      // STUDY-GO-STRAIGHT
    CWSL_REG_12                       = 10197,      // STUDY-GO-BACKWARD
    CWSL_REG_13                       = 10198,      // STUDY-TURN-LEFT
    CWSL_REG_14                       = 10199,      // STUDY-TURN-RIGHT
    CWSL_DEL_11                       = 10201,      // DELETE-GO-STRAIGHT
    CWSL_DEL_12                       = 10202,      // DELETE-GO-BACKWARD
    CWSL_DEL_13                       = 10203,      // DELETE-TURN-LEFT
    CWSL_DEL_14                       = 10204,      // DELETE-TURN-RIGHT
    CWSL_DELETE_SUCCESSFUL           = 20195,      // 删除成功
    CWSL_REGISTRATION_SUCCESSFUL     = 20196,      // 学习成功
    CWSL_TOO_SHORT                   = 20197,      // 语音长度不够
