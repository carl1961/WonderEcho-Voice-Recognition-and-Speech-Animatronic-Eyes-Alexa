...
build/objs/main.o : $(ROOT_DIR)/projects/cwsl_A_sample/src/main.c
	$(CC_PREFIX)$(CC) $(C_FLAGS) -c -o "$@" "$<"

OBJS += build/objs/system_hook.o
-include build/objs/system_hook.d
build/objs/system_hook.o : $(ROOT_DIR)/projects/cwsl_A_sample/src/system_hook.c
	$(CC_PREFIX)$(CC) $(C_FLAGS) -c -o "$@" "$<"

OBJS += build/objs/system_msg_deal.o
-include build/objs/system_msg_deal.d
build/objs/system_msg_deal.o : $(ROOT_DIR)/projects/cwsl_A_sample/src/system_msg_deal.c
	$(CC_PREFIX)$(CC) $(C_FLAGS) -c -o "$@" "$<"

OBJS += build/objs/user_msg_deal.o
-include build/objs/user_msg_deal.d
build/objs/user_msg_deal.o : $(ROOT_DIR)/projects/cwsl_A_sample/src/user_msg_deal.c
	$(CC_PREFIX)$(CC) $(C_FLAGS) -c -o "$@" "$<"

OBJS += build/objs/ci_ssp_config.o
-include build/objs/ci_ssp_config.d
build/objs/ci_ssp_config.o : $(ROOT_DIR)/projects/cwsl_A_sample/src/ci_ssp_config.c
	$(CC_PREFIX)$(CC) $(C_FLAGS) -c -o "$@" "$<"

OBJS += build/objs/cwsl_app_sample1.o
-include build/objs/cwsl_app_sample1.d
build/objs/cwsl_app_sample1.o : $(ROOT_DIR)/projects/cwsl_A_sample/src/cwsl_app_sample1.c
	$(CC_PREFIX)$(CC) $(C_FLAGS) -c -o "$@" "$<"

OBJS += build/objs/user_control.o
-include build/objs/user_control.d
build/objs/user_control.o : $(ROOT_DIR)/projects/cwsl_A_sample/src/user_control.c
	$(CC_PREFIX)$(CC) $(C_FLAGS) -c -o "$@" "$<"
...
C_FLAGS += -I$(ROOT_DIR)/projects/cwsl_A_sample/src
