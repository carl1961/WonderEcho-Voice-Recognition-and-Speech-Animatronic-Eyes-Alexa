...
static recv_cmd_pro_t recv_data[] = {
    ...
    {3,"\xAA\x55\x03\x00\xFB",5,0},  //HELLO-ROBOT
    ...
    {11,"\xAA\x55\x00\x01\xFB",5,0},  //CROSS-EYES
    {12,"\xAA\x55\x00\x02\xFB",5,0},  //LOOK-SCARED
    {13,"\xAA\x55\x00\x03\xFB",5,0},  //LOOK-LEFT
    {14,"\xAA\x55\x00\x04\xFB",5,0},  //LOOK-RIGHT
    {15,"\xAA\x55\x00\x05\xFB",5,0},  //WINK-EYE
    {16,"\xAA\x55\x00\x06\xFB",5,0},  //GO-TO-SLEEP
    {17,"\xAA\x55\x00\x07\xFB",5,0},  //WHISTLE
    {18,"\xAA\x55\x00\x08\xFB",5,0},  //HAPPY-WHISTLE
    ...
    {78,"\xAA\x55\x00\x7B\xFB",5,0},  //DETECTED-CLOSE-PLAY
    {79,"\xAA\x55\x00\x7C\xFB",5,0},  //SORT-YELLOW
    ...
    {101,"\xAA\x55\x00\xA1\xFB",5,0},  //EXECUTE-ACTION-ELEVEN
    ...
    {154,"\xAA\x55\xFF\x05\xFB",5,0},  //OBSTACLE-AHEAD
    ...
    {165,"\xAA\x55\xFF\x10\xFB",5,0},  //DETECT-OBJECT-AHEAD-GRABBING
    {166,"\xAA\x55\xFF\x11\xFB",5,0},  //DETECT-OBJECT-AHEAD-OUT-OF-REACH-CANNOT-GRAB
    {167,"\xAA\x55\xFF\x12\xFB",5,0},  //GRABBING-END
    {181,"\xAA\x55\xFF\x20\xFB",5,0},  //DETECTED-ZERO
    {182,"\xAA\x55\xFF\x21\xFB",5,0},  //DETECTED-ONE
    {183,"\xAA\x55\xFF\x22\xFB",5,0},  //DETECTED-TWO
    {184,"\xAA\x55\xFF\x23\xFB",5,0},  //DETECTED-THREE
    {185,"\xAA\x55\xFF\x24\xFB",5,0},  //DETECTED-FOUR
    {186,"\xAA\x55\xFF\x25\xFB",5,0},  //DETECTED-FIVE
    {187,"\xAA\x55\xFF\x26\xFB",5,0},  //DETECTED-SIX
    {188,"\xAA\x55\xFF\x27\xFB",5,0},  //DETECTED-SEVEN
    {189,"\xAA\x55\xFF\x28\xFB",5,0},  //DETECTED-EIGHT
    {190,"\xAA\x55\xFF\x29\xFB",5,0},  //DETECTED-NINE
    {191,"\xAA\x55\xFF\x2A\xFB",5,0},  //DETECTED-RED
    {192,"\xAA\x55\xFF\x2B\xFB",5,0},  //DETECTED-GREEN
    {193,"\xAA\x55\xFF\x2C\xFB",5,0},  //DETECTED-BLUE
    {194,"\xAA\x55\xFF\x2D\xFB",5,0},  //DETECTED-YELLOW
    {195,"\xAA\x55\xFF\x2E\xFB",5,0},  //DETECTED-PURPLE
...
static send_cmd_pro_t send_data[] = {
    ...
    {3,"\xAA\x55\x03\x00\xFB",5,1},  //HELLO-ROBOT
    ...
    {9,"\xAA\x55\x09\x00\xFB",5,0},  //START-BROADCASTING
    {10,"\xAA\x55\x0A\x00\xFB",5,0},  //STOP-BROADCASTING
    {11,"\xAA\x55\x00\x01\xFB",5,1},  //CROSS-EYES
    {12,"\xAA\x55\x00\x02\xFB",5,1},  //LOOK-SCARED
    {13,"\xAA\x55\x00\x03\xFB",5,1},  //LOOK-LEFT
    {14,"\xAA\x55\x00\x04\xFB",5,1},  //LOOK-RIGHT
    {15,"\xAA\x55\x00\x05\xFB",5,1},  //WINK-EYE
    {16,"\xAA\x55\x00\x06\xFB",5,1},  //GO-TO-SLEEP
    {17,"\xAA\x55\x00\x07\xFB",5,1},  //WHISTLE
    {18,"\xAA\x55\x00\x08\xFB",5,1},  //HAPPY-WHISTLE
    ...
    {78,"\xAA\x55\x00\x7B\xFB",5,1},  //DETECTED-CLOSE-PLAY
    {79,"\xAA\x55\x00\x7C\xFB",5,1},  //SORT-YELLOW
    ...
    {101,"\xAA\x55\x00\xA1\xFB",5,1},  //EXECUTE-ACTION-ELEVEN
